...
public class Synset extends PointerTarget implements DictionaryElement {
    ...
    /**
	 * @uml.property  name="pointers"
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:net.sf.extjwnl.data.Synset$PointerList"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(1 1)" inverse="this$0:net.sf.extjwnl.data.Synset$WordList"
	 */
    private final WordList words;

    /**
	 * The text (definition, usage examples) associated with the synset.
	 * @uml.property  name="gloss"
	 */
    private String gloss;

    /**
	 * The lexicographer file name id.
	 * @uml.property  name="lexFileNum"
	 */
