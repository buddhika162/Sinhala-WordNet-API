...
public class Pointer implements Serializable {
    ...
    /**
	 * @uml.property  name="pointerType"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private final PointerType pointerType;

    /**
	 * @uml.property  name="targetIndex"
	 * @uml.associationEnd  
	 */
    private TargetIndex targetIndex;

    /**
	 * The source of this pointer. If the pointer applies to all words in the parent synset, then <code>source</code> and <code>synset</code> are the same, otherwise <code>source</code> is the specific <code>Word</code> object that this pointer applies to.
