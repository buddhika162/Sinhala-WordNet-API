...
public abstract class Dictionary {
    ...
    /**
	 * @uml.property  name="editManageSymmetricPointers"
	 */
    ...
    /**
	 * @uml.property  name="editCheckAlienPointers"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" elementType="net.sf.extjwnl.dictionary.MorphologicalProcessor" qualifier="constant:java.lang.String net.sf.extjwnl.util.factory.Param"
	 */
    ...
    /**
	 * @uml.property  name="maxOffset"
	 * @uml.associationEnd  qualifier="pos:net.sf.extjwnl.data.POS java.lang.Long"
	 */
    ...
    public static Dictionary getInstance(InputSource properties) throws JWNLException {
        ...
        try {
        	...
        	System.out.println("exep this"+e);
            throw new JWNLException("UTILS_EXCEPTION_005", dictionaryClassName, e);
        }
