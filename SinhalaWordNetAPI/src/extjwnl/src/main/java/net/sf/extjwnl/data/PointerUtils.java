...
public class PointerUtils {
    ...
    public static PointerTargetNodeList getRoot(Synset synset) {
        return getPointerTargets(synset, PointerType.ROOT);
    }
    ...
    public static PointerTargetTree getInheritedRoot(Synset synset, int pointerDepth, int ancestorDepth) {
        return makeInheritedTree(synset, PointerType.ROOT, null, pointerDepth, ancestorDepth);
    }
