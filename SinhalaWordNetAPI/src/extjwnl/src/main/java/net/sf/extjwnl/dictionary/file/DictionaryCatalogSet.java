...
public class DictionaryCatalogSet<E extends DictionaryFile> implements Owned {
    ...
    /**
	 * @uml.property  name="catalogs"
	 * @uml.associationEnd  qualifier="EXCEPTION:net.sf.extjwnl.dictionary.file.DictionaryFileType net.sf.extjwnl.dictionary.file.DictionaryCatalog"
	 */
