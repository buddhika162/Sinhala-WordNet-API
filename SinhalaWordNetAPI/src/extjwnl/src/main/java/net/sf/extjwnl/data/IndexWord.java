...
public class IndexWord extends BaseDictionaryElement {
	 ...
	 * @uml.property  name="lemma"
	 */
    private String lemma;
    /**
	 * senses are initially stored as offsets, and paged in on demand.
	 * @uml.property  name="synsetOffsets"
	 */
    private long[] synsetOffsets;
    /**
	 * This is null until getSenses has been called.
	 * @uml.property  name="synsets"
	 * @uml.associationEnd  inverse="this$0:net.sf.extjwnl.data.IndexWord$SynsetList"
	 */
    ...
    /**
	 * Return the word's <it>lemma</it>.  Its lemma is its orthographic representation, for example <code>"dog"</code> or <code>"get up"</code>.
